...
public class CalculatorServiceImpl implements CalculatorService{
    ...
    public String plus(Double num1, Double num2) {
        if(num1.equals(null) || num2.equals(null)) {
            throw new CalculatorRuntimeException("Параметры не поданы");
        }
    ...
    @Override
    public String divide(Double num1, Double num2) throws CalculatorRuntimeException{
        if(num2 == 0) {
            throw new CalculatorRuntimeException("На ноль делить нельзя");
        }
        if(num1.equals(null) || num2.equals(null)) {
            throw new CalculatorRuntimeException("Параметры не поданы");
        }
